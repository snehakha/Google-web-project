...
import './App.css';
import UploadImage from './components/AddBlogForm';
...
function App() {
  ...
  return (
    ...
    <div className="App">
      ...
      <div className="header" id='home'>
        ...
        <nav className="navbar">
          <ul className="nav-list">
            ...
            <li className="right"><a href="#blogs"><button className="design">Blogs</button></a></li>
          </ul>
        </nav>
      </div>
      ...
      <section id='blogs'>
      <p className='shift'>Welcome to our blogging section dedicated to raising awareness about climate change and pollution! Here, users can share their insights, experiences, and knowledge through captivating blogs accompanied by impactful images. Whether it's highlighting the latest environmental research, discussing sustainable practices, or showcasing the consequences of pollution, our platform provides a space for individuals to contribute to the conversation on environmental preservation. Join us in spreading awareness and inspiring positive change for our planet's future. Upload your blogs and images today to be a part of the movement towards a cleaner, greener world!</p>
        <UploadImage/>
        <hr/>
      </section>
